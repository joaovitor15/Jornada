  ...
  const handleAuthError = (err: AuthError) => {
    ...
    switch (err.code) {
      ...
      case 'auth/wrong-password':
        return t.errorInvalidEmailPassword;
  ...
  const AuthForm = ({
    ...
    <CardContent className="space-y-4">
      ...
      <div className="space-y-2">
        <Label htmlFor={isSignUp ? 'signup-email' : 'login-email'}>{t.email}</Label>
        <Input
      ...
      <div className="space-y-2">
        <Label htmlFor={isSignUp ? 'signup-password' : 'login-password'}>{t.password}</Label>
        <Input
    ...
    <div className="w-full max-w-md">
      <Tabs defaultValue="login" className="w-full">
        ...
        <TabsContent value="signup">
          <Card>
            <CardHeader>
              <CardTitle>{t.startYourJourney}</CardTitle>
              <CardDescription>
