...
export const text = {
  ...
  reports: {
    ...
    grossProfitTooltip: 'Indica o lucro da atividade principal, antes de descontar despesas operacionais.\nCálculo: Receita Líquida - Custo dos Fornecedores.',
    ...
    cmv: 'Custo dos Fornecedores',
    cmvTooltip: "Representa o total de custos diretos com fornecedores.\nCálculo: Soma das despesas com Fornecedores.",
    costMargin: 'Margem de Custo',
    costMarginTooltip: "Mostra quanto do faturamento é consumido pelo custo dos produtos.\nCálculo: (Custo dos Fornecedores / Receita Líquida) * 100",
    personnelCost: 'Custo com Pessoal',
    personnelCostTooltip: "Soma de todas as despesas com a categoria 'Recursos Humanos'.",
    ...
    sistema: 'Sistemas e Tecnologias',
    sistemaTooltip: "Soma de todas as despesas com a categoria 'Sistemas e Tecnologias'.",
